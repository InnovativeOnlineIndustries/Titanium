...
public abstract class RotatableBlock<T extends RotatableBlock<T, U>, U extends BasicTile<T, U>> extends BasicTileBlock<T, U> {
    ...
    public RotatableBlock(String name, Properties properties, Class<U> tileClass) {
