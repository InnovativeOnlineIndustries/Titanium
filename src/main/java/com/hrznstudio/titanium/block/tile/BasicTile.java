...
public class BasicTile<T extends BasicTileBlock<T, U>, U extends BasicTile<T, U>> extends TileEntity {
    private T blockTileBase;

    public BasicTile(T base) {
    ...
    public BasicTileBlock getBlockTileBase() {
