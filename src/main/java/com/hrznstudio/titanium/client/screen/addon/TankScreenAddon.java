...
public class TankScreenAddon extends BasicScreenAddon {
            ...
            if (flowing != null) {
                ...
                if (texture instanceof AtlasTexture) {
                    ...
                    if (sprite != null) {
                        ...
                        Screen.func_238470_a_(stack, this.getPosX() + guiX + asset.getFluidRenderPadding(Direction.WEST),
    ...
    public List<ITextProperties> getTooltipLines() { ///TODO localize
        return Arrays.asList(TextFormatting.GOLD + "Fluid: " + TextFormatting.WHITE + (tank.getFluid().isEmpty() ? "Empty" : new TranslationTextComponent(tank.getFluid().getFluid().getAttributes().getTranslationKey(tank.getFluid())).func_230532_e_()), TextFormatting.GOLD + "Amount: " + TextFormatting.WHITE + new DecimalFormat().format(tank.getFluidAmount()) + TextFormatting.GOLD + "/" + TextFormatting.WHITE + new DecimalFormat().format(tank.getCapacity()) + TextFormatting.DARK_AQUA + "mb");
    }
