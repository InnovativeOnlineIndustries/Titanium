...
public class TileAssetTest extends TilePowered implements ITickableTileEntity {
    ...
    public TileAssetTest() {
        ...
        this.addInventory(realOutput = (SidedInvHandler) new SidedInvHandler("real_output", 120, 56, 1, 0).setButtonCoords(-15, 97).setInputFilter((stack, integer) -> IItemStackQuery.ANYTHING.test(stack)));
        ...
        this.addTank(fluidTank = (SidedFluidTank) new SidedFluidTank("fluid" , 16000, 150, 17, 0).setButtonCoords(-20, 127).setTile(this));
