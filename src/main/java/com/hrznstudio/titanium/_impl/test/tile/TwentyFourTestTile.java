...
public class TwentyFourTestTile extends PoweredTile<TwentyFourTestBlock, TwentyFourTestTile> implements ITickableTileEntity {

    @Save
    private PosProgressBar<TwentyFourTestTile> bar;
    ...
    public TwentyFourTestTile() {
        ...
        this.addProgressBar(bar = new PosProgressBar<TwentyFourTestTile>(20, 20, 500).setCanIncrease(tileEntity -> true).setOnFinishWork(() -> System.out.println("WOWOOW")));
