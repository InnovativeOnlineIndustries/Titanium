...
public class MachineTestBlock extends RotatableBlock<MachineTestBlock, MachineTestTile> {

    public static MachineTestBlock TEST;

    public MachineTestBlock() {
        super("machine_test", Properties.from(Blocks.IRON_BLOCK), MachineTestTile.class);
    }

    @Override
    public IFactory<MachineTestTile> getTileEntityFactory() {
        return () -> new MachineTestTile();
    }
}
